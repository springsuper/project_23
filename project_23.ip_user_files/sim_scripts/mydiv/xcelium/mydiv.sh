...
#
# Script generated by Vivado on Sun Dec 22 17:24:03 +0800 2024
...
#
# Usage        : mydiv.sh
#                mydiv.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mydiv.sh [-reset_run]
#                mydiv.sh [-reset_log]
#                mydiv.sh [-help]
#
...
#                script (type 'mydiv.sh -help' for more information).
#
...
# script info
echo -e "mydiv.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mydiv.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mydiv xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mydiv -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mydiv_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: mydiv.sh [-reset_log]\n\
Usage: mydiv.sh [-keep_index]\n\
