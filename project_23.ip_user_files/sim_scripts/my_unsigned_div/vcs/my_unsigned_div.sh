...
#
# Script generated by Vivado on Sun Dec 22 17:49:14 +0800 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : my_unsigned_div.sh
...
#
# Usage        : my_unsigned_div.sh
#                my_unsigned_div.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                my_unsigned_div.sh [-reset_run]
#                my_unsigned_div.sh [-reset_log]
#                my_unsigned_div.sh [-help]
#
...
#                script (type 'my_unsigned_div.sh -help' for more information).
#
...
# script info
echo -e "my_unsigned_div.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./my_unsigned_div.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.my_unsigned_div xil_defaultlib.glbl -o my_unsigned_div_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./my_unsigned_div_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key my_unsigned_div_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc my_unsigned_div_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./my_unsigned_div.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: my_unsigned_div.sh [-help]\n\
Usage: my_unsigned_div.sh [-step]\n\
Usage: my_unsigned_div.sh [-lib_map_path]\n\
Usage: my_unsigned_div.sh [-reset_run]\n\
Usage: my_unsigned_div.sh [-reset_log]\n\
Usage: my_unsigned_div.sh [-keep_index]\n\
Usage: my_unsigned_div.sh [-noclean_files]\n\n\
